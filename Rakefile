...
namespace :template do
  ...
  task :populate, [:vault_address, :library_name] do |t, args|
    ...
    Dir["#{directory_location}/**/*"].each do |path|
      ...
      contents = contents.gsub("awaitility-clj", library_name)
  ...
  task :vault, [:vault_address, :library_name] do |t, args|
      ...
      template_base_path = 'awaitility-clj'

      library_name = args.library_name.downcase

      puts 'copying value for clojars_deploy_username from awaitility-clj'
      ...
      puts 'copying value for clojars_deploy_token from awaitility-clj'
      ...
      puts 'copying value for application_builder_image_repository_url from awaitility-clj'
      ...
      puts 'copying value for application_builder_image_tag from awaitility-clj'
      ...
      puts 'copying value for slack_failure_channel from awaitility-clj'
      ...
      puts 'copying value for slack_failure_message from awaitility-clj'
      ...
      puts 'copying value for slack_success_channel from awaitility-clj'
      ...
      puts 'copying value for slack_success_message from awaitility-clj'
